<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('ordendeuso.store')); ?>"  method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="col-sm-8">
            ...
            <table class="table table-hover table-striped">
                ...
                <div class="form-group" >
                  ID                          <---- el nombre que vera el usuario a la hora de ver el campo, o sea si en este campo vas a colocar el nombre pones Nombre y asi con las de abajo
                ...
                <div class="form-group" >
                    ...
                    <input type="text"    name="fecha_uso" class="form-control">
